...
var index = require('./chunks/dep-40c65ceb.js');
require('fs');
require('path');
require('url');
require('tty');
...
cli
    ...
    // is ok here
    const { createServer } = await Promise.resolve().then(function () { return require('./chunks/dep-40c65ceb.js'); }).then(function (n) { return n.index$1; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    const { build } = await Promise.resolve().then(function () { return require('./chunks/dep-40c65ceb.js'); }).then(function (n) { return n.build$1; });
...
cli
    ...
    .option('--force', `[boolean] force the optimizer to ignore the cache and re-bundle`)
    .action(async (root, options) => {
    const { optimizeDeps } = await Promise.resolve().then(function () { return require('./chunks/dep-40c65ceb.js'); }).then(function (n) { return n.index; });
    try {
...
cli
    ...
    .option('--open [path]', `[boolean | string] open browser on startup`)
    .action(async (root, options) => {
    const { preview } = await Promise.resolve().then(function () { return require('./chunks/dep-40c65ceb.js'); }).then(function (n) { return n.preview$1; });
    try {
